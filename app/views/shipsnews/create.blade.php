        ...
        <div class='row-fluid'>
            ...
            <div class='span12'>
                ...
                <div class='block'>
                    ...
                    <div class='content'>
                        {{ Former::horizontal_open(route('shipsnews.store'))->method('POST')->id('form_ship_new') }}
                        <div class='offset2'>
                            <div class="control-group">
                                <label for="customer_id" class="control-label">Số công văn - Thuê bao</label>
                                <div class="controls">
                                    <select class="select2" id="customer_id" name="customer_id"  placeholder="Chọn số thuê bao đã đăng ký">
                                        <option></option>
