            ...
            <div class='span12'>
                ...
                <div class='block'>
                    ...
                    <div class='content'>
                        ...
                        {{ Former::horizontal_open(route('units.update',$unit->id))->method('PUT')->id('form_unit') }}
                        <div class='span10 offset2'>
                            ...
                            {{Former::radios('Thuộc khối')
                                        ->radios(array(
                                                    'An ninh' => array('name' => 'block', 'value' => 'AN', 'checked'),
                            ...
                            {{Former::radios('Thuộc khối')
                                        ->radios(array(
                                                    'An ninh' => array('name' => 'block', 'value' => 'AN'),
                                                    'Cảnh sát' => array('name' => 'block', 'value' => 'CS', 'checked'),
                                        ))
                                        ->inline()
                            }}
                            @endif
